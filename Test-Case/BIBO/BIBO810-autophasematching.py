...
########################################################
############################################################################################
my_data1 = genfromtxt('BIBO810.csv', delimiter='')
...
x1=sym.symbols('x1')
c=sym.symbols('c')
my_data =  genfromtxt('BIBO810.txt1', delimiter='')
...
#            print(valbas,theta2,phi2)
    ...
    with open("BIBO810-phasematching-deff.csv", 'w') as f:
...
#    print(tau[a],"   ",G2[a])
################################
    with open("BIBO810-G2.csv", 'w') as f:
        writer = csv.writer(f, delimiter='\t')
