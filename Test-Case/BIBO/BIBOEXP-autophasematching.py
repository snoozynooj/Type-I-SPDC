...
########################################################
############################################################################################
my_data1 = genfromtxt('BIBOEXP.csv', delimiter='')
...
x1=sym.symbols('x1')
c=sym.symbols('c')
my_data =  genfromtxt('BIBOEXP.txt1', delimiter='')
...
#            print(valbas,theta2,phi2)
    ...
    with open("BIBOEXP-phasematching-deff.csv", 'w') as f:
...
#    print(tau[a],"   ",G2[a])
################################
    with open("BIBOEXP-G2.csv", 'w') as f:
        writer = csv.writer(f, delimiter='\t')
