...
set title "Signal = 1064 nm, (X, Y, Z -> a, b, c)"
plot "KTP-phasematching-deff.csv" u 3:2 w p lw 0.1 lt 6 lc 7  t "KTP-Calculated", \
     "KTPEXP-phasematching-deff.csv" u 3:2 w p lw 0.1 lt 6 lc 3  t "KTP-EXP", \
