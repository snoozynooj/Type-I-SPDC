...
########################################################
############################################################################################
my_data1 = genfromtxt('KTP.csv', delimiter='')
...
x1=sym.symbols('x1')
c=sym.symbols('c')
my_data =  genfromtxt('KTP.txt1', delimiter='')
...
#            print(valbas,theta2,phi2)
    ...
    with open("KTPEXP-phasematching-deff.csv", 'w') as f:
...
#    print(tau[a],"   ",G2[a])
################################
    with open("KTPEXP-G2.csv", 'w') as f:
        writer = csv.writer(f, delimiter='\t')
